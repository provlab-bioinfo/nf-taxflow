...
workflow CLASSIFYREADS_LONG {
    ...
    CSVTK_CONCAT_TOPMATCHES(
            CLASSIFYREADS_COMMON.out.bracken_topmatches
                ...
                .collect()
                .map { csvs ->
                    tuple([id: "reads_long_kraken2_bracken.topmatches"], csvs)
                },
        ...
        CSVTK_CONCAT_TAXPROF(
            CLASSIFYREADS_COMMON.out.sylph_taxprof
                ...
                .collect()
                .map { csvs ->
                    tuple([id: "reads_long.sylph-tax_taxprof.filtered"], csvs)
                },
        ...
        CSVTK_CONCAT_SINGLEM(
            CLASSIFYREADS_COMMON.out.singlem_profile_filtered
                ...
                .collect()
                .map { csvs ->
                    tuple([id: "reads_long.singlem_profile_filtered"], csvs)
                },
